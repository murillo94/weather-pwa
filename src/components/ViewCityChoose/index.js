...
const ViewCityChoose = (props) => (
	<Wrapper>
		...
		<TemperatureInfos tempMin={props.tempMin} tempMax={props.tempMax} 
		humidity={props.humidity} wind={props.wind} sizeIcon={18} sizeText={15} 
		colorIcon="#c9c9c9" colorText="#fff" />
	</Wrapper>
)
